      ...
      <div class="containerx">
        ...
        <div class="ContentView">
          @if (session('notify'))
            ...
            @endif
              <h2 class="titleTool">Update music</h2>

              <div class="formInfoAdmin">
                  @foreach ($dbshows as $dbshow)
                      
                  
                  <form action="{{ route('post.music.update') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <input type="hidden" value="{{ $dbshow->id }}" name="id">
                      <div class="form-group">
                        <Strong style="color: crimson">*</Strong> <label class="titleInput" for="nameSong">Name</label>
                        <input type="text" value="{{ $dbshow->NameSong }}" class="form-input" name="NameSong">
                        @error('NameSong')
                      ...
                      <div class="form-group">
                        <img width="300px" src="images/imgSong/{{ $dbshow->ImageSong }}" alt="">
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="file" name="XImageSong" class="form-input">
                          <input type="hidden" name="ImageSong" value="{{ $dbshow->ImageSong }}" class="form-input">
                          @error('ImageSong')
                          <div class="alert alert-danger">{{ $message }}</div>
                          @enderror
                        </div>
                        <div class="col-sm-6">
                          ...
                          <input type="file" name="XfileSong" class="form-input">
                          <input type="hidden" name="fileSong" value="{{ $dbshow->fileSong }}" class="form-input">
                          @error('fileSong')
                          <div class="alert alert-danger">{{ $message }}</div>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        <audio style="width: 100%;" style="outline: none" controls>
                            <source src="images/filesong/{{ $dbshow->fileSong }}" type="audio/mpeg">
                          </audio> 
                      </div>
                      ...
                      <div class="form-group row">
                        <div class="col-sm-6">
                          ...
                          <select name="idCategorySong" class="form-input" id="">
                              ...
                              <option class="alert alert-dark" value="{{ $dbshow->CategorySong->id }}">{{ $dbshow->CategorySong->nameSong }}</option>
                        ...
                        <div class="col-sm-6">
                          ...
                          <select name="idSinger" class="form-input" id="">
                            <option class="alert alert-dark" value="{{ $dbshow->CategotySinger->id }}">{{ $dbshow->CategotySinger->NameSinger }}</option>
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="Lyrics" class="form-texarea" id="" cols="30" rows="10">
                            {{ $dbshow->Lyrics }}
                        </textarea>
                       @error('Lyrics')
                        <div class="alert alert-danger">{{ $message }}</div>
